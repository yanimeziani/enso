...
export class JavaScriptRuntimeModule {
     ...
     */
    static generateInstallChunkRuntime(webpack, withOnload) {
     ...
     */
    static generateChunkOnloadRuntime(webpack) {
     ...
     */
    static generateChunkLoadingRuntime(webpack, matcher) {
     ...
     */
    static generateHMRRuntime(webpack) {
     ...
     */
    static generateHMRManifestRuntime(webpack) {
        const { Template } = webpack;
        return Template.asString([
            '',
