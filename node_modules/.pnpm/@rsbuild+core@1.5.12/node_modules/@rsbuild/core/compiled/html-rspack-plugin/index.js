(() => {
  var __webpack_modules__ = {
    269: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      const { HtmlWebpackChildCompiler } = __nccwpck_require__(430);
    ...
    320: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
    ...
    832: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      const { CachedChildCompilation } = __nccwpck_require__(269);
      const { createHtmlTagObject, htmlTagObjectToString, HtmlTagArray } =
        __nccwpck_require__(301);
      const prettyError = __nccwpck_require__(801);
      const chunkSorter = __nccwpck_require__(78);
      const getHtmlRspackPluginHooks =
        __nccwpck_require__(320).getHtmlRspackPluginHooks;
